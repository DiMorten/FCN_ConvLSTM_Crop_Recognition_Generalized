...
python patches_store.py --dataset_source=%dataset_source% --dataset_name=%dataset% -mm="ram" --debug=1 -pl 32 -po 0 -ts 0 -tnl 10000 -bs=5000 --batch_size=128 --filters=256 -m="smcnn_semantic" --phase="repeat" -sc=False --log_dir="../data/summaries/" --id_first=1 -tof=False -nap=10000 -psv=True --seq_mode=%seq_mode% --seq_date=%seq_date%
